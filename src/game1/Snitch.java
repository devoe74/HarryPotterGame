...
public class Snitch extends Thread {// הכדור שצריך לתפוס
    ...
    public void paint (Graphics graphics){
        ImageIcon snitchImage = new ImageIcon(Main.ADD_TO_PATH + "resources\\images\\Snitch2.2.1.gif");
        snitchImage.paintIcon(null, graphics, this.x, this.y);

        for (int i = 0; i < this.snitchsToCatch; i++) {
            ImageIcon snitchCounterSymbol = new ImageIcon(Main.ADD_TO_PATH + "resources\\images\\SnitchBlurPhoto.png");
