...
public class StartHomePage2 extends JPanel {
    ...
    public StartHomePage2(){
        ...
        this.changTheLanguageButton = new JButton(new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\English&Flag.2.png"));
    ...
    public void paintComponent (Graphics graphics) {
        ...
        ImageIcon startHomePageImage = new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\StartBackground2.2.4.2.jpg");
    ...
    public void changTheLanguage(){
        ...
        if (this.hebrewOrEnglish){
            ...
            this.changTheLanguageButton.setIcon(new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\English&Flag.2.png"));
        }else {
            this.information.setText(englishText);
            this.information.setBounds(220,70,1600,690);
            this.changTheLanguageButton.setIcon(new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\Hebrew&Flag.png"));
