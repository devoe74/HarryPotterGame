...
public class Background extends Thread{
    ...
    public void paint(Graphics graphics){
        ImageIcon backgroundImage3 = new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\Background1.2.4.jpg");
        backgroundImage3.paintIcon(null, graphics, BACKGROUND1_START_x, ALL_THE_BACKGROUNDS_Y);
        ImageIcon backgroundImage1 = new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\Background1.2.4.jpg");
        backgroundImage1.paintIcon(null, graphics, backgroundImage1X, ALL_THE_BACKGROUNDS_Y);
        ImageIcon backgroundImage2 = new ImageIcon(Utils.ADD_TO_PATH + "resources\\images\\Background2.2.4.jpg");
